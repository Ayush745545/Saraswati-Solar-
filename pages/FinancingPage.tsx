...
import { Calculator, ArrowRight, Building2, Percent, Gift, CheckCircle2, ChevronRight } from 'lucide-react';
...
const FinancingPage: React.FC<FinancingPageProps> = ({ onOpenCalculator }) => {
  ...
  return (
    <section className="pt-20 bg-slate-50/50 min-h-screen">
      ...
      {/* Process Section */}
      <div className="bg-white py-24 md:py-32 border-t border-slate-50">
